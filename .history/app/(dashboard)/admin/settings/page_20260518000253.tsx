    ...
    try {
      ...
      if (!notified) {
        toast({
          ...
          description:
            "Impossible de charger les paramètres. Vérifie ta connexion.",
          variant: "destructive",
        })
        setNotified(true)
      }
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Input {...register("language")} placeholder="Langue (fr/en)" />
                  <Input {...register("currency")} placeholder="Devise" />
                </div>
              </CardContent>
            </Card>
          </TabsContent>
