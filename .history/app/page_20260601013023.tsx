...
export default function LandingPage() {
  ...
  return (
    <main className="relative overflow-hidden bg-white text-black transition-colors duration-500 dark:bg-black dark:text-white">
      ...
      <header className="fixed top-0 z-50 w-full border-b border-black/5 bg-white/70 backdrop-blur-3xl dark:border-white/10 dark:bg-black/70">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          <Link href="/" className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 via-green-300 to-emerald-500 shadow-lg">
        ...
        <div className="mx-auto max-w-7xl text-center">
          ...
          >
            ...
            <h1 className="mx-auto max-w-6xl text-5xl font-bold leading-tight tracking-tight md:text-6xl xl:text-7xl">
              ...
              <span className="bg-gradient-to-r  from-green-800 via-green-500 to-green-300 bg-clip-text text-transparent">
                {" "}
                autrement.
              </span>
            </h1>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                {operators.map(
                  (item) => (
                    <div
                      key={item.name}
                      className=" flex rounded-3xl bg-white/10 p-8 backdrop-blur-xl "
                    >
                      <h3 className="text-2xl font-bold">
                        {item.name}
                          <Image
      ...
      <section className="px-6 py-40">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[60px] bg-gradient-to-br from-green-400 via-green-500 to-emerald-700 p-14 text-white">
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 xl:grid-cols-3">
            ...
            <motion.div
              whileHover={{ y: -12 }}
              className="relative overflow-hidden rounded-[40px] border border-cyan-500 bg-gradient-to-br from-green-500 to-green-600 p-10 text-white shadow-[0_20px_80px_rgba(6,182,212,0.3)]"
            >
            ...
            {[
              ...
              >
                <div className="mb-8 flex items-center gap-4">
                  <div className="h-14 w-14 rounded-full bg-gradient-to-r from-green-800 to-green-500" />
...
<section className="relative px-6 py-40">
  <div className="mx-auto max-w-7xl">
    <div className="overflow-hidden rounded-[60px] bg-gradient-to-br  from-green-500 via-green-700 to-emerald-900 px-12 py-32 text-center text-white shadow-[0_30px_120px_rgba(59,130,246,0.4)]">
