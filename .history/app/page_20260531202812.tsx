...
<section className="relative px-6 py-40">
  <div className="mx-auto max-w-7xl">
    <div className="overflow-hidden rounded-[60px] bg-gradient-to-br  from-green-500 via-green-300 to-emerald-500 px-12 py-32 text-center text-white shadow-[0_30px_120px_rgba(59,130,246,0.4)]">
