      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/30 backdrop-blur-2xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-green-300">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* 🌙 MODE NUIT TOGGLE (AJOUT UNIQUEMENT) */}
            <button
            ...
            <Link href="/register">
              <button className="rounded-2xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold transition hover:bg-emerald-500">
                Commencer
              </button>
            </Link>
          </div>
