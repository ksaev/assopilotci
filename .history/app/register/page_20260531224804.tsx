...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="w-full max-w-fullbg-muted/30 flex items-center justify-center p-4">

      <div className="w-full max-w-full grid lg:grid-cols-2 bg-background rounded-3xl overflow-hidden shadow-2xl border">

        {/* === LEFT MARKETING === */}
        <div className="hidden lg:relative bg-gradient-to-br from-emerald-950 via-emerald-900 to-black p-12">
