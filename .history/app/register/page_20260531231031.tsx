...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex items-center justify-center p-0">

      <div className="w-full max-w-full grid lg:grid-cols-2 bg-background rounded-3xl overflow-hidden shadow-2xl border">

        {/* === LEFT MARKETING === */}
        <div className="hidden lg:flex relative bg-linear-to-br from-emerald-950 via-emerald-900 to-black p-20">
         ...
         {/* === FORM === */}
        <div className="p-10 sm:p-18 flex items-center justify-center">
          ...
          >
            ...
            <a href="/login" className=" text-green-700 text-sm font-medium hover:underline flex items-center justify-center mt-4">
