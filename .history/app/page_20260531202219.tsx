...
export default function LandingPage() {
  ...
  return (
    <main className="relative overflow-hidden bg-white text-black transition-colors duration-500 dark:bg-black dark:text-white">
      ...
      <section className="px-6 py-40">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[60px] bg-gradient-to-br  from-green-800 via-green-500 to-green-300 text-white">
          <div className="grid items-center gap-16 xl:grid-cols-2">
            <div>
              <span className="rounded-full bg-white/500 px-4 py-2 text-sm">
                Enterprise Suite
              </span>
