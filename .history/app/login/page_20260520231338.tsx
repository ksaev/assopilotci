...
export default function LoginPage() {
  ...
  const resetTimer = () => {
    ...
    // ⏱ refresh seulement après 2 minutes d'activité continue
  ...
  useEffect(() => {
    ...
    const checkAndRefresh = async () => {
      ...
      // 🔥 condition clé : utilisateur actif dans les 2 dernières minutes
      const isActive = now - lastActivity < 1000 * 60 * 2
    ...
    const interval = setInterval(checkAndRefresh, 1000 * 60 * 2)
