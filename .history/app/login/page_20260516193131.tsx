        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-sidebar-foreground">
          ...
          >
            <motion.div
              ...
              className="w-24 h-24 rounded-2xl bg-primary flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-primary/30"
            >
              <span className="text-primary-foreground font-bold text-4xl">GA</span>
            </motion.div>

            <h1 className="text-4xl font-bold mb-4 text-balance">GestionAsso CI</h1>
            <p className="text-xl text-sidebar-foreground/70 mb-8 max-w-md text-pretty">
              La plateforme de gestion d'association moderne pour la Côte d'Ivoire
            </p>

            <div className="grid grid-cols-2 gap-6 max-w-md">
              {[
                { icon: User, label: "20+ Membres", desc: "Actifs" },
                { icon: Shield, label: "Sécurisé", desc: "100%" },
              ].map((item, index) => (
                <motion.div
                  key={item.label}
                  initial={{ opacity: 0, y: 20 }}
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="font-bold text-xl">GestionAsso CI</h1>
              <p className="text-xs text-muted-foreground">Côte d'Ivoire</p>
            </div>
          </div>
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent>
              <Tabs value={userType} onValueChange={(v) => setUserType(v as "admin" | "member")} className="mb-6">
              ...
              <div className="mt-6 text-center text-sm text-muted-foreground">
                ...
                <a href="/create-organization" className="text-primary hover:underline font-medium">
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">© 2025 GestionAsso CI. Tous droits réservés.</p>
        </motion.div>
      </div>
    </div>
  )
