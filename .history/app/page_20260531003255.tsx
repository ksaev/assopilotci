...
<section className="relative px-6 py-40">
  <div className="mx-auto max-w-7xl">
    <div className="overflow-hidden rounded-[60px] bg-gradient-to-br from-cyan-600 via-blue-600 to-violet-700 px-12 py-32 text-center text-white shadow-[0_30px_120px_rgba(59,130,246,0.4)]">
      ...
      <section className="relative px-6 py-40">
        <div className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[60px] bg-gradient-to-br from-cyan-600 via-blue-600 to-violet-700 px-12 py-28 text-center text-white shadow-[0_30px_120px_rgba(59,130,246,0.35)]">
            ...
            <div className="relative">
              ...
              <h2 className="mx-auto mt-10 max-w-5xl text-5xl font-bold leading-tight md:text-6xl">
                Transformez la manière
                dont votre organisation fonctionne.
              </h2>

              <p className="mx-auto mt-8 max-w-3xl text-xl text-white/80">
                Rejoignez les associations qui utilisent
                déjà une plateforme moderne pour gérer
                leurs membres, leurs finances et leur croissance.
              </p>
