...
export default function LandingPage() {
  ...
  return (
    <main className="relative overflow-hidden bg-black text-white transition-colors duration-500 dark:bg-white dark:text-black">
      {/* BACKGROUND */}
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-white/70 backdrop-blur-3xl dark:border-white/10 dark:bg-black/70">
