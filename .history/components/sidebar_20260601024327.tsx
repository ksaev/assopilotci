...
export const buildAdminLinks = (slug: string) => ({
  dashboard: `/${slug}/admin/dashboard`,
  members: `/${slug}/admin/members`,
  solidarity: `/${slug}/admin/solidarity`,
  transactions: `/${slug}/admin/transactions`,
  events: `/${slug}/admin/events`,
  reports: `/${slug}/admin/reports`,
  documents: `/${slug}/admin/documents`,
  notes: `/${slug}/admin/notes`,
